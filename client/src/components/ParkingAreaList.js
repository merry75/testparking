        ...
        <Container className="align-items-center">
          ...
          <Row sm={12}>
            {parkingAreaList != null && parkingAreaList.length !== 0 ? (
              ...
              <Col>
                <div className="text-center">There is no parking area.</div>
              </Col>
            )}
          </Row>
        </Container>
...
const mapDispatchToProps = dispatch => {
  return {
    getParkingArea: value => {
      dispatch(actions.getParkingArea(value));
    },
    getBookList: value => {
      dispatch(actions.getBookList(value));
    }
  };
};
